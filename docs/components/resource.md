...
<div class="cards">
    <ul class="container">   
        <li >
            <div class="card">
                <img src="https://xxx.com/docs/b4b910e7f5919defa0b936c4fe03f4d.png" alt="">
                <h3>Sketch Template</h3>
                <p>通过在Sketch中导入uView组件库，可以在交互设计阶段方便地调用常用的组件</p>
                <a href="https://xxx.com/resources/sketch.sketch">下载</a>
            </div>
        </li>
        <li >
            <div class="card">
                <img src="https://xxx.com/docs/9d24f116e345f13d2fc46734fbcd7a9.png" alt="">
                <h3>Axure Template</h3>
                <p>通过在Axure中导入uView组件库，可以在交互设计阶段方便地调用常用的组件，需要Axure9.0版本打开</p>
                <a href="https://xxx.com/resources/axure.rp">下载</a>
            </div>
        </li>
    </ul>
</div>
...
<div class="cards">
    <ul class="container">   
        <li >
            <div class="card">
                <img src="https://xxx.com/docs/8bfdfc21701f891066ad24b8cc57049.png" alt="">
                <h3>I18n多语言示例</h3>
                <p>我们为您制作了一个I18n多语言的示例工程，下载运行即可，注意此版本不适用于nvue</p>
                <a href="https://xxx.com/resources/i18n.zip">下载</a>
            </div>
        </li>
        <li >
            <div class="card">
                <img src="https://xxx.com/docs/1381ec6a792cc682a7ee12138e720f9.png" alt="">
                <h3>脚手架空白工程</h3>
                <p>已配置uView的空白项目，适用于新项目或者学习使用，下载后在HX中运行即可</p>
                <a href="https://xxx.com/resources/uView-cli.zip">下载</a>
            </div>
        </li>
        <li >
            <div class="card">
                <img src="https://xxx.com/docs/66130bf3f548c34ed755128d2e1e285.png" alt="">
                <h3>Tabbar组件使用示例</h3>
                <p>请注意配合文档说明使用此组件，这里为组件的使用示例工程，下载即可使用</p>
                <a href="https://xxx.com/resources/Tabbar.zip">下载</a>
            </div>
        </li>
        <li >
            <div class="card">
                <img src="https://xxx.com/docs/425b2a05e181894a8e3f09f4d95af4e.png" alt="">
                <h3>Empty组件配套占位图</h3>
